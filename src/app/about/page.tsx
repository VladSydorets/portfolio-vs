...
export default function About() {
  return (
    <div className="container flex flex-col items-center min-h-screen p-16">
      <div className="mb-12">
        <h1 className="text-5xl text-[#A855F7] font-medium">About me</h1>
      </div>
      <div className="content flex">
        <div className="card w-1/3 flex flex-col items-center gap-4">
          <div className="rounded-full w-48 h-48 bg-purple-700"></div>
          <div className="card-desc text-center">
            <h2 className="text-2xl font-medium mb-1">Vlad Sydorets</h2>
            <p className="text-base text-slate-400">Software Engineer</p>
          </div>
          <SocialIcons></SocialIcons>
        </div>
        <div className="desc-text text-slate-400 flex flex-col gap-4 w-2/3">
          <p>
      ...
      <h1 className="text-5xl text-[#A855F7] font-medium mt-12">Skills</h1>
